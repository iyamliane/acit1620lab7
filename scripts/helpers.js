...
export function getCheckbox() {
     ...
     * Get checkbox node
     */
    return document.querySelector('#tries-checkbox'); //document.querySelector('input[type="checkbox"]) 
}
...
export function setCard() {
    ...
    cardNode.classList.toggle('hidden', true);
     ...
     getCardNode().classList.toggle('flip', false);
     getCardNode().parentElement.classlist.toggle('fade', false);
}
...
export function showCard() {
    ...
    // animate the card
    getCardNode().classList.toggle('flip', true);
    getCardNode().parentElement.classlist.toggle('fade', true);
